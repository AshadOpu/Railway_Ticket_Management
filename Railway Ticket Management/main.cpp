...
public:
    ...
    void displayresdet()
    {
        ...
        for(i=0; i<nosr; i++)
        {
            cout<<"Passenger name:";
            puts(pname[i]);
            cout<<endl<<"Passenger age:"<<age[i]<<endl;
        }

        cout<<"\nYour class:";
        puts(clas);
        cout<<endl<<"\nDate of reservation:"<<d<<"-"<<m<<"-"<<y<<endl;
        cout<<"\nYour concession category:"<<con<<endl;
...
public:
    ...
    void displaycancdet()
    {
        ...
        cout<<endl<<"no of seats to be cancelled:"<<nosc;
        for(i=0; i<nosc; i++)
        {
            cout<<"\nPassenger name:";
            puts(pname[i]);
...
void database()
{
    ...
    if(strcmp(pass,password)==0)
    {
        ...
        do
        {
            ...
            case 1:
                system("CLS");
                f.open("Train_Schedule.txt",ios::out|ios::binary);
                do
                {
                    a.getdetail();
            ...
            case 2:
                system("CLS");
                f.open("Train_Schedule.txt",ios::in|ios::out|ios::binary|ios::app);
                a.getdetail();
                f.write((char *) & a,sizeof(a));
                system("CLS");
                f.close();
...
void reserve()
{
    ...
    fstream f1,f2;
    time_t t;
    f1.open("Train_Schedule.txt",ios::in|ios::out|ios::binary);
    f2.open("Reserved.txt",ios::in|ios::out|ios::binary|ios::app);
    b.getresdet();
...
void displaypassdetail()
{
    fstream f;
    reser b;
    f.open("Reserved.txt",ios::in|ios::out|ios::binary);
    f.seekg(0);
...
void enquiry()
{
    ...
    fstream f;
    f.open("Train_Schedule.txt",ios::in|ios::out|ios::binary);
    detail a;
    cout<<"Tno"<<"   "<<"Tname"<<"     "<<"Bp"<<"    "<<"Dest"
        <<"\t"<<"C1"<<"   "<<"C1fare"<<"    "<<"C2"<<"    "<<"C2fare"
        <<"\t"<<"Date"<<endl;
...
void cancell()
{
    ...
    fstream f1,f2,f3;
    f1.open("Train_Schedule.txt",ios::in|ios::out|ios::binary);
    f2.open("Reserved.txt",ios::in|ios::out|ios::binary);
...
void user()
{
    ...
    password=(char*)malloc(100*sizeof(char));
    fstream f;
    f.open("User_Id.txt",ios::in|ios::out|ios::binary);
    char id[100];
    cout<<"Enter your id:";
    cin>>id;
...
void manage()
{
    ...
    do
    {
        ...
        {
        case 1:
            f.open("User_Id.txt",ios::out|ios::binary);
            do
            {
                a.getid();
                f.write((char *) & a,sizeof(a));
            ...
            break;
        case 2:
            f.open("User_Id.txt",ios::in|ios::out|ios::binary|ios::app);
            a.getid();
            f.write((char *) & a,sizeof(a));
            system("pause");
            system("CLS");
